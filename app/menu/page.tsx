    ...
    return (
        <main className="mt-16">
            ...
            <section>
                ...
                <div className="mt-5 mb-16 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-6xl px-10">
            ...
            <section>
                ...
                <div className="mt-5 mb-15 mx-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-6xl px-10">
